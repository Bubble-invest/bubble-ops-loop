...
description: >-
  ...
  catch operator PII ({{OPERATOR}}/{{OPERATOR_2}} Telegram IDs), internal infra (Tailscale
  ...
  or whenever {{OPERATOR}} says "is this clean to share / can this go public / scan for
