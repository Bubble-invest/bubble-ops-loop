...
REARM_TURN = (
    ...
    "wiki/HANDOFF if unsure) — and pass its ENTIRE stdout to CronCreate as the prompt, "
    "VERBATIM: never compose, paraphrase, edit, or append your own wording. Its output "
    "is guaranteed to be your full tick protocol text and NEVER a bare slash-command "
    "like /loop-now — that invariant is now enforced by the generator, not by your own "
    "drafting. "
