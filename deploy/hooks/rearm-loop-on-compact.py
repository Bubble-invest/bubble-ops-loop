...
REARM_TURN = (
    ...
    "dept.yaml doesn't yet use the loop.due_dispatch schema this generator "
    "understands, or nothing is live/due right now): do NOT retry composing your own "
    ...
    "ONLY (never Telegram — this is a KNOWN gap on VPS until its follow-up lands, "
    "and every re-arm/compaction firing on Telegram would spam the operator) naming "
