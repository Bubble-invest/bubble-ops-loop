...
Joris directive (msg 2734 + 2737, 2026-05-21): non-tech users will ask our
...
for Joris, 1ère personne for the agent, no jargon).
...
def test_claude_md_bureau_de_cadre_voice_preserved():
    """The new principles must keep the Bureau-de-Cadre voice (Joris in 2e
